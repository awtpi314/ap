...
public class SortComparison {
    ...
    //   size = readInt();
      if (size > 0){
        ...
        //  choice = readInt();
         ...
         // insertion sort
         System.out.println("\ninsertin sort ...");
         //System.out.println("insertion comparison count: " + SortArrayList.insertionSort(myArray, true));
   ...
   */
   public static void createRandomArray(ArrayList<Integer> array, int size) {         
      int num; 
      for (int counter = 0; counter < size; counter++){
         //array[counter] = (int)(2 * size * Math.random());      // initial list of random numbers
...
/*
  ----jGRASP exec: java SortComparison
